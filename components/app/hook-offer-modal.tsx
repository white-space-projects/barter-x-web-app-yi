  ...
  return (
    <>
      ...
      <div
        ...
        onClick={onClose}
      />
      {/* Modal - centered in content area with flex layout for proper scrolling */}
      <div className="fixed z-[70] inset-0 m-4 lg:m-0 lg:inset-auto lg:left-[calc(50%+7rem)] lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:w-full lg:max-w-md rounded-xl border border-border bg-card shadow-2xl lg:max-h-[85vh] flex flex-col overflow-hidden">
        {/* Header - fixed */}
        ...
        {/* Footer - fixed */}
        <div className="flex-shrink-0 p-6 pt-4 border-t border-border bg-card">
          <div className="flex gap-3">
            <button
              onClick={onClose}
